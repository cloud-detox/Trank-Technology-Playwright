...
class technology:
    ...
    def ecommSubMenu_Click(self):    
     for i in self.lsteCommSubMenus:    
            ...
            takeScrnsht(self.page, "TechnologiesSubmenuecomm")
            # self.page.go_back()
    ...
    def mobileAppDev_Click(self):    
     for i in self.lstMobAppSubMenus:    
            ...
            i.click()
            self.page.wait_for_load_state()
            takeScrnsht(self.page, "TechnologiesSubmenumobileAppDev")
            # self.page.go_back()
    ...
    #  for i in self.lstAI:  # Assuming self.lstAI is defined and contains AI sub-menu locators
        self.technology_Mouseover()
        self.ai_Mouseover()
        # i.click()
        
        self.page.wait_for_load_state()
        takeScrnsht(self.page, "TechnologiesSubmenuAI")
