class blog:
    def __init__(self,page):
        ...
        #search:
        self.search=page.locator('//span[text()="Search"]')
        self.searchbar=page.locator('//input[@placeholder="Search..."]')
        self.searchbutton=page.locator('//button[@class="search_submit"]')
    ...
    def search_blog(self):
        ...
        self.page.wait_for_timeout(1000)
        self.search.click()
        self.searchbar.fill("digital marketing")
